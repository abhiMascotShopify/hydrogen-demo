...
// app/swym/Utils.js
var LOCAL_STORAGE_TAG_NAME = "swym-data";
var getSwymLocalStorage = () => {
  return JSON.parse(
    window.localStorage.getItem(LOCAL_STORAGE_TAG_NAME) || "{}"
  );
};
var setSwymLocalStorage = (value) => {
...
var _global = typeof self === "undefined" ? typeof globalThis === "undefined" ? void 0 : globalThis : self;
...
// app/swym/swym.config.js
var SWYM_CONFIG = {
  REST_API_KEY: "ZqthS4PnfTMF44_S0CvUgxWTEQ-oW5-fJtFKOjOlhED6QCDImHoXrDfWAlaFYHxc5-NeTm5uZ64mGDGNHQ7-4Q",
...
var swym_config_default = SWYM_CONFIG;

// app/swym/store-apis.js
var SWYM_PID = swym_config_default.PID;
var callGenrateRegidAPI = async ({
  appId = "Wishlist",
  ...
  return await axios_default.post("/api/genrateRegid/", {
    appId,
    useragenttype
  }).then((responseJSON) => {
    setSwymLocalStorage({
...
var getWishlistSocialCount = async ({ empi }, skipCache = false) => {
  try {
    let localCahce = getSwymLocalStorage();
    let cachedProducts = localCahce.products;
    let currProductIdx = cachedProducts && cachedProducts.findIndex((product) => product.empi == empi);
    ...
    const response = await fetch(
      `${swym_config_default.ENDPOINT}api/v3/product/wishlist/social-count?${queryParams}`,
      requestOptions
    );
...
//# sourceMappingURL=/build/routes/($locale).products.$handle-NQ3CWNXQ.js.map
