...
function ProductMain({ selectedVariant, product, variants }) {
  ...
  product.images.edges.forEach((item, index) => {
    map.set("img" + index, item.node.url);
  });
  console.log(map);
  ...
  const [activeImg, setActiveImage] = (0, import_react3.useState)(images.img0);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col justify-between lg:flex-row gap-16 lg:items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col gap-6 lg:w-2/4", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-row justify-between h-24", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: images.img0, alt: "", className: "w-24 h-24 rounded-md cursor-pointer", onClick: () => setActiveImage(images.img0) }, void 0, false, {
            fileName: "app/routes/($locale).products.$handle.jsx",
            lineNumber: 210,
            columnNumber: 25
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: images.img1, alt: "", className: "w-24 h-24 rounded-md cursor-pointer", onClick: () => setActiveImage(images.img1) }, void 0, false, {
            fileName: "app/routes/($locale).products.$handle.jsx",
            lineNumber: 211,
            columnNumber: 25
          }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col gap-4 lg:w-2/4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: " text-violet-600 font-semibold", children: "Special Sneaker" }, void 0, false, {
            fileName: "app/routes/($locale).products.$handle.jsx",
            lineNumber: 217,
            columnNumber: 25
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-3xl font-bold", children: "Nike Invincible 3" }, void 0, false, {
            fileName: "app/routes/($locale).products.$handle.jsx",
            lineNumber: 218,
            columnNumber: 25
          }, this)
...
//# sourceMappingURL=/build/routes/($locale).products.$handle-OGMDZM4N.js.map
