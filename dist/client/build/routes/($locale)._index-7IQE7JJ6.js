...
} from "/build/_shared/chunk-7V63PUB5.js";
import {
...
var require_slider = __commonJS({
  "node_modules/react-slick/lib/slider.js"(exports) {
    ...
    var Slider4 = exports["default"] = /* @__PURE__ */ function(_React$Component) {
      _inherits(Slider5, _React$Component);
      var _super = _createSuper(Slider5);
...
var MobileProductCorousel = ({ products, title, settings }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full max-w-screen-2xl mx-auto px-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_react_slick2.default, { ...settings, children: products.nodes.map(
      (product) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "px-2 bg-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { href: `/blogs/${product.handle}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
        "img",
        {
...
var Testimonials = ({ page }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "wrapper text-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h1", { children: " Testimonials " }, void 0, false, {
      fileName: "app/components/Testimonials.jsx",
      lineNumber: 6,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("ul", { class: "carousel", children: context.map((content, index2) => {
...
function Homepage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "home", children: [
    isSmall ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("section", { className: "collectionContent lg:hidden block sm:mt-4 overflow-auto ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "inline-flex gap-4 w-[100%]", children: collectionArrayStatic?.map((item, index2) => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
      "div",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_react_slick3.default, { ...settings, children: collectionCult.map((coll, index2) => {
        return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "mx-4 px-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "bg-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
          "img",
          {
            onClick: () => goToCollection(`/collections/${coll.handle}`),
            src: `${coll.url}`,
...
//# sourceMappingURL=/build/routes/($locale)._index-7IQE7JJ6.js.map
