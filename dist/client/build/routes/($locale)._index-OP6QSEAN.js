...
var LooksComp = ({ looks }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "looks", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 px-0 sm:px-20", children: products.map((product) => {
...
//# sourceMappingURL=/build/routes/($locale)._index-OP6QSEAN.js.map
