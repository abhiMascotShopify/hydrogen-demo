  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
      "img",
      {
        src: activeImg,
        alt: "",
        className: "w-[55%] h-full aspect-square object-cover rounded-xl p-[10px] border-1 border-[#e5e5e5]"
      },
      void 0,
      false,
      {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex  flex-row justify-between h-full overflow-y-auto gap-[5px]", children: product.images.edges && product.images.edges.map((item, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
      "img",
      {
        src: images[index],
        alt: "",
...
function ProductMain({ selectedVariant: selectedVariant2, product, variants }) {
  ...
  const [more2, setMore2] = (0, import_react5.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "final-product shadow-lg p-4 flex flex-col justify-between lg:flex-row gap-16 lg:m-8 lg:items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-col gap-6 lg:w-2/4 flex-wrap items-center sticky top-[100px]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
        ProductImage,
        {
...
function ProductOptions({ option, activeImg, setActiveImage }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("ul", { className: "text-[#757575]", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("span", { onClick: () => setMore(!more), className: "text-red-700", children: "+View More" }, void 0, false, {
          fileName: "app/routes/($locale).products.$handle.jsx",
          lineNumber: 478,
          columnNumber: 11
        }, this),
        !more && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: "hdcbkjdcj" }, void 0, false, {
          fileName: "app/routes/($locale).products.$handle.jsx",
          lineNumber: 481,
          columnNumber: 21
        }, this)
...
//# sourceMappingURL=/build/routes/($locale).products.$handle-TQCVGVSG.js.map
