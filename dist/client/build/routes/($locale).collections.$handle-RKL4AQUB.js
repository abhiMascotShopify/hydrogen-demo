...
var filters = [
  ...
  },
  {
    ...
    options: [
      { value: "0", label: '"\u20B90 - \u20B9299"' },
      { value: "299", label: "\u20B9300 - \u20B9499" },
      { value: "499", label: "\u20B9500 - \u20B9899" },
      { value: "899", label: "\u20B9900+" }
    ]
  }
];
...
function Collection() {
  ...
  const [productsToShow1, setProductToShow] = (0, import_react34.useState)([]);
  ...
  const sortArray = (data, sortOrder = "ascending") => {
    ...
    const sortedData = [...data].sort((a12, b6) => {
      var nodeA = a12.node, nodeB = b6.node;
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "mx-auto max-w-8xl px-4 sm:px-6 lg:px-8", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { "aria-labelledby": "products-heading", className: "pb-24 pt-6", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "lg:col-span-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full max-w-screen-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "cursor product-card grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4", children: productsToShow.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "cursor", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { onClick: () => goToProduct(`/products/${product.handle}`), children: [
                    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                      "img",
                      {
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-RKL4AQUB.js.map
