...
function ProductForm({
      ...
      if (success) {
        ...
        fetch("https://appapi.shipdelight.com/serviceability_tat", { method: "POST", headers, body: JSON.stringify(params) }).then((res) => res.json()).then((result2) => {
          ...
          if (errors?.length) {
            ...
            const isServicebale = response.delivery_pincode_serviceable;
            const msg = data2?.response.delivery_pincode_serviceable ? "Service is available to your location" : "Service is not available at this location";
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "product-form", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mb-2", children: [
      ...
      serviceble.status != null && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: serviceble.status ? "text-green-500" : "text-orange-500", children: [
        " ",
        serviceble.msg,
        " "
      ] }, void 0, true, {
...
//# sourceMappingURL=/build/routes/($locale).products.$handle-5WQ55HRR.js.map
