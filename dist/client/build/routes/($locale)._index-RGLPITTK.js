...
} from '/build/_shared/chunk-GSYWZ7VI.js';
...
var MobileProductCorousel = ({products, title}) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    'div',
    {
      className: 'w-full max-w-screen-2xl mx-auto px-1 ',
        ...
        'div',
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
              'h1',
              {className: 'text-center', children: title},
              void 0,
              false,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
              'div',
              {
                className: 'flex overflow-y-auto product-40',
                children: products.map((product) =>
                  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                    'img',
                    {
                      ...
                      alt: product.name,
                      className:
                        'w-full h-auto rounded-lg lg:px-5 sm:px-3 sm:mx-3 mr-2',
                    },
                    void 0,
                    false,
                    {
            ...
            'div',
            {
              ...
              children: [
                  ...
                  'div',
                  {
                    ...
                    children: productsToShow.map((product) =>
                      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                        'div',
                        {
                          className: 'w-full sm:w-1/3 md:w-1/3 px-4',
                          children: /* @__PURE__ */ (0,
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                  ...
                  {
                    className:
                      'absolute left-[5px] top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 rounded-full ml-1 p-2 mr-2 hover:bg-opacity-75',
                    onClick: () =>
                      setStartIndex((prevIndex) =>
                        prevIndex === 0
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                  ...
                  {
                    className:
                      'absolute right-0 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 rounded-full p-2 mr-4 hover:bg-opacity-75',
                    onClick: () =>
                      setStartIndex(
                        (prevIndex) => (prevIndex + 3) % products.length,
                      ),
                    children: /* @__PURE__ */ (0,
                    import_jsx_dev_runtime.jsxDEV)(
                      MdChevronRight,
        ...
        'div',
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
              'h1',
              {
                className: 'text-center lg:text=[28px] text-[20px] mt-0',
                children: 'Choose Your Own Fashion',
              },
              void 0,
              false,
              {
                ...
                children: products.map((product) =>
                  /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                    'img',
                    {
                      ...
                      alt: product.title,
                      className:
                        'lg:w-full lg:h-auto rounded-lg lg:px-5 sm:px-3 sm:mx-3 h-[40%] w-[250px]',
                    },
                    void 0,
                    false,
                    {
            ...
            'div',
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                  ...
                  {
                    className:
                      'absolute left-0 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 rounded-full ml-1 hover:bg-opacity-75',
                    onClick: () =>
                      setStartIndex((prevIndex) =>
                        prevIndex === 0
                          ? products.length - (products.length % 3)
        ...
        'div',
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
              'h1',
              {
                className: 'text-center mt-0 lg:text-[28px] text-[20px]',
                children: 'Choose Your Own Fashion',
              },
              void 0,
              false,
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
              ...
              {
                className: 'flex gap-2 overflow-y-auto',
                children: products.nodes.map((product) =>
                  /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
                    'img',
                    {
                      ...
                      alt: product.title,
                      className:
                        'lg:w-full lg:h-auto rounded-lg lg:px-5 sm:px-3 sm:mx-3 w-[250px] h-[40%]',
                    },
                    void 0,
                    false,
                    {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            'div',
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
                  'h1',
                  {className: 'text-center', children: 'Blogs'},
                  void 0,
                  false,
                  {
                    fileName: 'app/components/BlogCorousel.jsx',
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
                  ...
                  {
                    className:
                      'absolute left-0 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 rounded-full p-2 mr-4 hover:bg-opacity-75',
                    onClick: () =>
                      setStartIndex((prevIndex) =>
                        prevIndex === 0
                          ? products.length - (products.length % 3)
...
var BlogCorousel = ({collections}) => {
  const isLargeScreen = (0, import_react_responsive3.useMediaQuery)({
    minWidth: 1024,
  });
...
function Homepage() {
  ...
  const isLargeScreen = (0, import_react_responsive4.useMediaQuery)({
    minWidth: 1024,
  });
    ...
    'div',
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          ...
          {
            className:
              'collectionContent lg:hidden block sm:mt-4 overflow-auto',
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
              'div',
              {
                className: 'inline-flex gap-4',
                children: collectionArray?.map((item, index) =>
                  /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
                    'div',
                    {
                      className:
                        'collection-items sm:w-auto w-[30%] bg-[#f5f5f5] rounded-lg hover:shadow-md cursor-pointer',
                      children: [
                        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
                          'div',
                          {
                        ...
                        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
                          ...
                          {
                            className:
                              'collectionname  sm:text-lg text-md font-semibold  text-center px-[15px] pb-[12px]  pt-[5px]',
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          ...
          {collections: GiftCollections, title: 'Gifting'},
          void 0,
          false,
          {
            fileName: 'app/routes/($locale)._index.jsx',
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          BlogCorousel_default,
          {collections: data.blogs},
          void 0,
          false,
          {
            fileName: 'app/routes/($locale)._index.jsx',
...
function RecommendedProducts({products, title}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
    import_jsx_dev_runtime4.Fragment,
    {
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          'h1',
          {className: 'text-center font-semibold', children: [title, ' ']},
          void 0,
          true,
          {
            fileName: 'app/routes/($locale)._index.jsx',
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          'div',
          {
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
                import_react5.Suspense,
                {
                  fallback: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
                    'div',
                    {children: 'Loading...'},
                    void 0,
                    false,
...
export {Homepage as default, meta};
//# sourceMappingURL=/build/routes/($locale)._index-RGLPITTK.js.map
