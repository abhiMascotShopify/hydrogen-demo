...
} from "/build/_shared/chunk-QSH2LBVW.js";
...
function Homepage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "home", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("section", { className: "collectionContent sm:mt-4 overflow-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "inline-flex gap-4", children: collectionArray?.map((item, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
      "div",
      {
        className: "collection-items test bg-[#f5f5f5] rounded-lg hover:shadow-md cursor-pointer",
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "image", onClick: () => window.location.href = item.url, children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            "img",
            {
              width: 300,
              height: 300,
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "collectionname  sm:text-lg text-md font-semibold  text-center px-[15px] pb-[12px]  pt-[5px]", children: item.collectionname }, void 0, false, {
            fileName: "app/routes/($locale)._index.jsx",
            lineNumber: 217,
            columnNumber: 17
          }, this)
...
//# sourceMappingURL=/build/routes/($locale)._index-YF6WDEU5.js.map
