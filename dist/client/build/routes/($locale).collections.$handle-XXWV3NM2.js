...
function Collection() {
  var collectionArray = [];
  const { collection, header, handle, all_collections } = useLoaderData();
  const { menu } = header;
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-XXWV3NM2.js.map
