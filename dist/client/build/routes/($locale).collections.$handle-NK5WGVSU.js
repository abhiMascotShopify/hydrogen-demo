...
import {
  XMarkIcon_default
} from "/build/_shared/chunk-7WSGMIWG.js";
import {
  require_react_dom
} from "/build/_shared/chunk-JGYP5LFQ.js";
import {
  F
...
var I = (o5 = import_react5.default.useId) != null ? o5 : function() {
  let n6 = l2(), [e4, u9] = import_react5.default.useState(n6 ? () => s.nextId() : null);
  return l(() => {
    e4 === null && u9(s.nextId());
...
function f(e4 = document.body) {
  return e4 == null ? [] : Array.from(e4.querySelectorAll(c2)).sort((r8, t17) => Math.sign((r8.tabIndex || Number.MAX_SAFE_INTEGER) - (t17.tabIndex || Number.MAX_SAFE_INTEGER)));
}
...
function O(e4, r8, { sorted: t17 = true, relativeTo: l11 = null, skipElements: o10 = [] } = {}) {
...
function F3({ container: e4, accept: t17, walk: r8, enabled: c12 = true }) {
  let o10 = (0, import_react11.useRef)(t17), l11 = (0, import_react11.useRef)(r8);
  (0, import_react11.useEffect)(() => {
    o10.current = t17, l11.current = r8;
  }, [t17, r8]), l(() => {
    if (!e4 || !c12)
      return;
    let n6 = e(e4);
...
function X({ ourProps: r8, theirProps: t17, slot: e4, defaultTag: a12, features: s14, visible: n6 = true, name: f10 }) {
  ...
  if (u9 & 1) {
    ...
    return u(l11 ? 0 : 1, { [0]() {
      ...
      return c3({ ...p6, hidden: true, style: { display: "none" } }, e4, a12, f10);
    } });
  }
  return c3(o10, e4, a12, f10);
}
function c3(r8, t17 = {}, e4, a12) {
  let { as: s14 = e4, children: n6, refName: f10 = "ref", ...o10 } = g(r8, ["unmount", "static"]), u9 = r8.ref !== void 0 ? { [f10]: r8.ref } : {}, l11 = typeof n6 == "function" ? n6(t17) : n6;
  ...
  if (s14 === import_react12.Fragment && Object.keys(R(o10)).length > 0) {
    if (!(0, import_react12.isValidElement)(l11) || Array.isArray(l11) && l11.length > 1)
...
`)].join(`
`));
    let i6 = l11.props, m10 = typeof (i6 == null ? void 0 : i6.className) == "function" ? (...d11) => t6(i6 == null ? void 0 : i6.className(...d11), o10.className) : t6(i6 == null ? void 0 : i6.className, o10.className), y6 = m10 ? { className: m10 } : {};
    return (0, import_react12.cloneElement)(l11, Object.assign({}, N2(l11.props, R(g(o10, ["ref"]))), p6, u9, w2(l11.ref, u9.ref), y6));
  }
  return (0, import_react12.createElement)(s14, Object.assign({}, g(o10, ["ref"]), s14 !== import_react12.Fragment && u9, s14 !== import_react12.Fragment && p6), l11);
}
function w2(...r8) {
...
function c5({ value: o10, children: r8 }) {
...
function X2(t17, r8) {
  let e4 = (0, import_react21.useRef)(null), o10 = y2(e4, r8), { initialFocus: u9, containers: i6, features: n6 = 30, ...l11 } = t17;
  l2() || (n6 = 1);
  let m10 = n2(e4);
  Y({ ownerDocument: m10 }, Boolean(n6 & 16));
  let c12 = Z({ ownerDocument: m10, container: e4, initialFocus: u9 }, Boolean(n6 & 2));
  ...
  return import_react21.default.createElement(import_react21.default.Fragment, null, Boolean(n6 & 4) && import_react21.default.createElement(c4, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: y6, features: p2.Focusable }), X({ ourProps: j5, theirProps: l11, defaultTag: J, name: "FocusTrap" }), Boolean(n6 & 4) && import_react21.default.createElement(c4, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: y6, features: p2.Focusable }));
}
var z = D2(X2);
...
function $({ ownerDocument: t17, container: r8, containers: e4, previousActiveElement: o10 }, u9) {
  ...
  E3(t17 == null ? void 0 : t17.defaultView, "focus", (n6) => {
    ...
    if (!m10)
      return;
    let c12 = n6.target;
    c12 && c12 instanceof HTMLElement ? S3(l11, c12) ? (o10.current = c12, y(c12)) : (n6.preventDefault(), n6.stopPropagation(), y(m10)) : y(o10.current);
  }, true);
}
function S3(t17, r8) {
  for (let e4 of t17)
...
// node_modules/@headlessui/react/dist/components/portal/portal.js
function F4(p6) {
  let l11 = l5(), n6 = (0, import_react23.useContext)(v), e4 = n2(p6), [a12, o10] = (0, import_react23.useState)(() => {
...
function N3(p6, l11) {
  let n6 = p6, e4 = (0, import_react23.useRef)(null), a12 = y2(T2((u9) => {
    e4.current = u9;
  }), l11), o10 = n2(e4), t17 = F4(e4), [r8] = (0, import_react23.useState)(() => {
    var u9;
    return s.isServer ? null : (u9 = o10 == null ? void 0 : o10.createElement("div")) != null ? u9 : null;
  }), i6 = (0, import_react23.useContext)(f6), C4 = l2();
  return l(() => {
...
function j2(p6, l11) {
  let { target: n6, ...e4 } = p6, o10 = { ref: y2(l11) };
...
function ae() {
  let p6 = (0, import_react23.useContext)(f6), l11 = (0, import_react23.useRef)([]), n6 = o4((o10) => (l11.current.push(o10), p6 && p6.register(o10), () => e4(o10))), e4 = o4((o10) => {
    let t17 = l11.current.indexOf(o10);
    t17 !== -1 && l11.current.splice(t17, 1), p6 && p6.unregister(o10);
  }), a12 = (0, import_react23.useMemo)(() => ({ register: n6, unregister: e4, portals: l11 }), [n6, e4, l11]);
  return [l11, (0, import_react23.useMemo)(() => function({ children: t17 }) {
...
function M3({ children: i6, onUpdate: r8, type: e4, element: n6, enabled: u9 }) {
  let l11 = x3(), o10 = o4((...t17) => {
    r8 == null || r8(...t17), l11(...t17);
  });
  return l(() => {
...
var { useState: u6, useEffect: h6, useLayoutEffect: f8, useDebugValue: p4 } = l7;
...
var s12 = !r6;
var c9 = s12 ? t14 : y4;
var a6 = "useSyncExternalStore" in e3 ? ((n6) => n6.useSyncExternalStore)(e3) : c9;
...
function c10() {
  ...
  return { before({ doc: e4 }) {
    ...
    let t17 = e4.documentElement, l11 = t17.clientWidth - t17.offsetWidth, r8 = o10 - l11;
      ...
      t17.addEventListener(o10, "click", (e4) => {
        if (e4.target instanceof HTMLElement)
          try {
            ...
            if (!r8)
              return;
            let { hash: c12 } = new URL(r8.href), a12 = o10.querySelector(c12);
            a12 && !i6(a12) && (n6 = a12);
          } catch {
          }
...
var a8 = a7(() => /* @__PURE__ */ new Map(), { PUSH(e4, n6) {
  ...
  c12.forEach(({ before: r8 }) => r8 == null ? void 0 : r8(o10)), c12.forEach(({ after: r8 }) => r8 == null ? void 0 : r8(o10));
}, SCROLL_ALLOW({ d: e4 }) {
  e4.dispose();
}, TEARDOWN({ doc: e4 }) {
  this.delete(e4);
...
function j3({ defaultContainers: t17 = [], portals: r8, mainTreeNodeRef: u9 } = {}) {
  var c12;
  let o10 = (0, import_react26.useRef)((c12 = u9 == null ? void 0 : u9.current) != null ? c12 : null), l11 = n2(o10), f10 = o4(() => {
    var i6;
    let n6 = [];
    for (let e4 of t17)
  ...
  return { resolveContainers: f10, contains: o4((n6) => f10().some((i6) => i6.contains(n6))), mainTreeNodeRef: o10, MainTreeNode: (0, import_react26.useMemo)(() => function() {
    return u9 != null ? null : import_react26.default.createElement(c4, { features: p2.Hidden, ref: o10 });
  }, [o10, u9]) };
}
...
function Ne(t17, e4) {
  var X4;
  let o10 = I(), { id: i6 = `headlessui-dialog-${o10}`, open: n6, onClose: l11, initialFocus: s14, __demoMode: g6 = false, ...T7 } = t17, [m10, h9] = (0, import_react27.useState)(0), a12 = C();
  ...
  let p6 = n6 ? 0 : 1, [S9, Z4] = (0, import_react27.useReducer)(Be, { titleId: null, descriptionId: null, panelRef: (0, import_react27.createRef)() }), P4 = o4(() => l11(false)), W2 = o4((r8) => Z4({ type: 0, id: r8 })), L2 = l2() ? g6 ? false : p6 === 0 : false, F7 = m10 > 1, Y4 = (0, import_react27.useContext)(I4) !== null, [ee2, te2] = ae(), { resolveContainers: M7, mainTreeNodeRef: k2, MainTreeNode: oe3 } = j3({ portals: ee2, defaultContainers: [(X4 = S9.panelRef.current) != null ? X4 : D5.current] }), re2 = F7 ? "parent" : "leaf", $4 = a12 !== null ? (a12 & d5.Closing) === d5.Closing : false, ne2 = (() => Y4 || $4 ? false : L2)(), le3 = (0, import_react27.useCallback)(() => {
    var r8, c12;
    return (c12 = Array.from((r8 = f10 == null ? void 0 : f10.querySelectorAll("body > *")) != null ? r8 : []).find((d11) => d11.id === "headlessui-portal-root" ? false : d11.contains(k2.current) && d11 instanceof HTMLElement)) != null ? c12 : null;
  }, [k2]);
  h7(le3, ne2);
  let ae3 = (() => F7 ? true : L2)(), ie2 = (0, import_react27.useCallback)(() => {
    var r8, c12;
    return (c12 = Array.from((r8 = f10 == null ? void 0 : f10.querySelectorAll("[data-headlessui-portal]")) != null ? r8 : []).find((d11) => d11.contains(k2.current) && d11 instanceof HTMLElement)) != null ? c12 : null;
  }, [k2]);
  h7(ie2, ae3);
  let se3 = (() => !(!L2 || F7))();
  h2(M7, P4, se3);
  ...
  return import_react27.default.createElement(M3, { type: "Dialog", enabled: p6 === 0, element: D5, onUpdate: o4((r8, c12) => {
    c12 === "Dialog" && u(r8, { [s11.Add]: () => h9((d11) => d11 + 1), [s11.Remove]: () => h9((d11) => d11 - 1) });
...
var Ue = "div";
function We(t17, e4) {
  let o10 = I(), { id: i6 = `headlessui-dialog-overlay-${o10}`, ...n6 } = t17, [{ dialogState: l11, close: s14 }] = b3("Dialog.Overlay"), g6 = y2(e4), T7 = o4((a12) => {
  ...
  }), m10 = (0, import_react27.useMemo)(() => ({ open: l11 === 0 }), [l11]);
  return X({ ourProps: { ref: g6, id: i6, "aria-hidden": true, onClick: T7 }, theirProps: n6, slot: m10, defaultTag: Ue, name: "Dialog.Overlay" });
}
var Ye = "div";
function $e(t17, e4) {
  let o10 = I(), { id: i6 = `headlessui-dialog-backdrop-${o10}`, ...n6 } = t17, [{ dialogState: l11 }, s14] = b3("Dialog.Backdrop"), g6 = y2(e4);
  (0, import_react27.useEffect)(() => {
    if (s14.panelRef.current === null)
      throw new Error("A <Dialog.Backdrop /> component is being used, but a <Dialog.Panel /> component is missing.");
  }, [s14.panelRef]);
  let T7 = (0, import_react27.useMemo)(() => ({ open: l11 === 0 }), [l11]);
...
var Je = "div";
function Xe(t17, e4) {
  let o10 = I(), { id: i6 = `headlessui-dialog-panel-${o10}`, ...n6 } = t17, [{ dialogState: l11 }, s14] = b3("Dialog.Panel"), g6 = y2(e4, s14.panelRef), T7 = (0, import_react27.useMemo)(() => ({ open: l11 === 0 }), [l11]), m10 = o4((a12) => {
    a12.stopPropagation();
  });
...
var je = "h2";
function Ke(t17, e4) {
  let o10 = I(), { id: i6 = `headlessui-dialog-title-${o10}`, ...n6 } = t17, [{ dialogState: l11, setTitleId: s14 }] = b3("Dialog.Title"), g6 = y2(e4);
...
function ee(e4, n6) {
  let { defaultOpen: o10 = false, ...u9 } = e4, T7 = (0, import_react29.useRef)(null), l11 = y2(n6, T2((a12) => {
    T7.current = a12;
  }, e4.as === void 0 || e4.as === import_react29.Fragment)), t17 = (0, import_react29.useRef)(null), f10 = (0, import_react29.useRef)(null), s14 = (0, import_react29.useReducer)(Y2, { disclosureState: o10 ? 0 : 1, linkedPanel: false, buttonRef: f10, panelRef: t17, buttonId: null, panelId: null }), [{ disclosureState: i6, buttonId: c12 }, D5] = s14, d11 = o4((a12) => {
    D5({ type: 1 });
    let r8 = e(T7);
    if (!r8 || !c12)
      return;
    let p6 = (() => a12 ? a12 instanceof HTMLElement ? a12 : a12.current instanceof HTMLElement ? a12.current : r8.getElementById(c12) : r8.getElementById(c12))();
    p6 == null || p6.focus();
  }), P4 = (0, import_react29.useMemo)(() => ({ close: d11 }), [d11]), b6 = (0, import_react29.useMemo)(() => ({ open: i6 === 0, close: d11 }), [i6, d11]), y6 = { ref: l11 };
  return import_react29.default.createElement(k.Provider, { value: s14 }, import_react29.default.createElement(v2.Provider, { value: P4 }, import_react29.default.createElement(c5, { value: u(i6, { [0]: d5.Open, [1]: d5.Closed }) }, X({ ourProps: y6, theirProps: u9, slot: b6, defaultTag: Z2, name: "Disclosure" }))));
}
var te = "button";
function ne(e4, n6) {
  let o10 = I(), { id: u9 = `headlessui-disclosure-button-${o10}`, ...T7 } = e4, [l11, t17] = M4("Disclosure.Button"), f10 = V(), s14 = f10 === null ? false : f10 === l11.panelId, i6 = (0, import_react29.useRef)(null), c12 = y2(i6, n6, s14 ? null : l11.buttonRef);
  ...
  let D5 = o4((r8) => {
    ...
    if (s14) {
      ...
      switch (r8.key) {
        case o7.Space:
        case o7.Enter:
          r8.preventDefault(), r8.stopPropagation(), t17({ type: 0 }), (p6 = l11.buttonRef.current) == null || p6.focus();
          break;
      }
    } else
      switch (r8.key) {
    ...
    var p6;
    r2(r8.currentTarget) || e4.disabled || (s14 ? (t17({ type: 0 }), (p6 = l11.buttonRef.current) == null || p6.focus()) : t17({ type: 0 }));
  }), b6 = (0, import_react29.useMemo)(() => ({ open: l11.disclosureState === 0 }), [l11]), y6 = s6(e4, i6), a12 = s14 ? { ref: c12, type: y6, onKeyDown: D5, onClick: P4 } : { ref: c12, id: u9, type: y6, "aria-expanded": l11.disclosureState === 0, "aria-controls": l11.linkedPanel ? l11.panelId : void 0, onKeyDown: D5, onKeyUp: d11, onClick: P4 };
  return X({ ourProps: a12, theirProps: T7, slot: b6, defaultTag: te, name: "Disclosure.Button" });
}
var le = "div";
var oe = S2.RenderStrategy | S2.Static;
function re(e4, n6) {
  let o10 = I(), { id: u9 = `headlessui-disclosure-panel-${o10}`, ...T7 } = e4, [l11, t17] = M4("Disclosure.Panel"), { close: f10 } = w4("Disclosure.Panel"), s14 = y2(n6, l11.panelRef, (P4) => {
    a10(() => t17({ type: P4 ? 4 : 5 }));
  });
  (0, import_react29.useEffect)(() => (t17({ type: 3, panelId: u9 }), () => {
    t17({ type: 3, panelId: null });
  }), [u9, t17]);
  let i6 = C(), c12 = (() => i6 !== null ? (i6 & d5.Open) === d5.Open : l11.disclosureState === 0)(), D5 = (0, import_react29.useMemo)(() => ({ open: l11.disclosureState === 0, close: f10 }), [l11, f10]), d11 = { ref: s14, id: u9 };
  return import_react29.default.createElement(H3.Provider, { value: l11.panelId }, X({ ourProps: d11, theirProps: T7, slot: D5, defaultTag: le, features: oe, visible: c12, name: "Disclosure.Panel" }));
}
var se = D2(ee);
var ue = D2(ne);
var ie = D2(re);
...
function Me2(e4, u9) {
  let { __demoMode: r8 = false, ...i6 } = e4, s14 = (0, import_react31.useReducer)(ye2, { __demoMode: r8, menuState: r8 ? 0 : 1, buttonRef: (0, import_react31.createRef)(), itemsRef: (0, import_react31.createRef)(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: t17, itemsRef: o10, buttonRef: a12 }, l11] = s14, m10 = y2(u9);
  h2([a12, o10], (g6, R3) => {
    var p6;
    l11({ type: 1 }), h(R3, T.Loose) || (g6.preventDefault(), (p6 = a12.current) == null || p6.focus());
  }, t17 === 0);
  let I6 = o4(() => {
    l11({ type: 1 });
  }), A = (0, import_react31.useMemo)(() => ({ open: t17 === 0, close: I6 }), [t17, I6]), f10 = { ref: m10 };
  return import_react31.default.createElement(U2.Provider, { value: s14 }, import_react31.default.createElement(c5, { value: u(t17, { [0]: d5.Open, [1]: d5.Closed }) }, X({ ourProps: f10, theirProps: i6, slot: A, defaultTag: Ie2, name: "Menu" })));
}
var ge2 = "button";
function Re(e4, u9) {
  var R3;
  let r8 = I(), { id: i6 = `headlessui-menu-button-${r8}`, ...s14 } = e4, [t17, o10] = O2("Menu.Button"), a12 = y2(t17.buttonRef, u9), l11 = p(), m10 = o4((p6) => {
    switch (p6.key) {
      case o7.Space:
      case o7.Enter:
      case o7.ArrowDown:
        p6.preventDefault(), p6.stopPropagation(), o10({ type: 0 }), l11.nextFrame(() => o10({ type: 2, focus: a2.First }));
        break;
      case o7.ArrowUp:
        p6.preventDefault(), p6.stopPropagation(), o10({ type: 0 }), l11.nextFrame(() => o10({ type: 2, focus: a2.Last }));
        break;
    }
  }), I6 = o4((p6) => {
    switch (p6.key) {
...
function Ee(e4, u9) {
  var M7, b6;
  let r8 = I(), { id: i6 = `headlessui-menu-items-${r8}`, ...s14 } = e4, [t17, o10] = O2("Menu.Items"), a12 = y2(t17.itemsRef, u9), l11 = n2(t17.itemsRef), m10 = p(), I6 = C(), A = (() => I6 !== null ? (I6 & d5.Open) === d5.Open : t17.menuState === 0)();
...
function Pe2(e4, u9) {
  let r8 = I(), { id: i6 = `headlessui-menu-item-${r8}`, disabled: s14 = false, ...t17 } = e4, [o10, a12] = O2("Menu.Item"), l11 = o10.activeItemIndex !== null ? o10.items[o10.activeItemIndex].id === i6 : false, m10 = (0, import_react31.useRef)(null), I6 = y2(u9, m10);
  l(() => {
  ...
  let g6 = o4(() => {
    ...
    M7.wasMoved(T7) && (s14 || l11 || a12({ type: 2, focus: a2.Specific, id: i6, trigger: 0 }));
  }), E8 = o4((T7) => {
    M7.wasMoved(T7) && (s14 || l11 && a12({ type: 2, focus: a2.Nothing }));
  }), P4 = (0, import_react31.useMemo)(() => ({ active: l11, disabled: s14, close: g6 }), [l11, s14, g6]);
...
function c11(a12 = 0) {
  let [l11, r8] = (0, import_react32.useState)(a12), t17 = f5(), o10 = (0, import_react32.useCallback)((e4) => {
    t17.current && r8((u9) => u9 | e4);
  }, [l11, t17]), m10 = (0, import_react32.useCallback)((e4) => Boolean(l11 & e4), [l11]), s14 = (0, import_react32.useCallback)((e4) => {
    t17.current && r8((u9) => u9 & ~e4);
...
function b5(t17, e4) {
  ...
  let { transitionDuration: m10, transitionDelay: a12 } = getComputedStyle(t17), [u9, p6] = [m10, a12].map((l11) => {
    let [r8 = 0] = l11.split(",").filter(Boolean).map((i6) => i6.includes("ms") ? parseFloat(i6) : parseFloat(i6) * 1e3).sort((i6, T7) => T7 - i6);
    return r8;
  }), o10 = u9 + p6;
  if (o10 !== 0) {
    n6.group((r8) => {
    ...
    let l11 = n6.addEventListener(t17, "transitionend", (r8) => {
      r8.target === r8.currentTarget && (e4(), l11());
    });
  } else
    e4();
...
function M5(t17, e4, n6, m10) {
  let a12 = n6 ? "enter" : "leave", u9 = o2(), p6 = m10 !== void 0 ? l10(m10) : () => {
  };
  a12 === "enter" && (t17.removeAttribute("hidden"), t17.style.display = "");
  let o10 = u(a12, { enter: () => e4.enter, leave: () => e4.leave }), l11 = u(a12, { enter: () => e4.enterTo, leave: () => e4.leaveTo }), r8 = u(a12, { enter: () => e4.enterFrom, leave: () => e4.leaveFrom });
  return v3(t17, ...e4.base, ...e4.enter, ...e4.enterTo, ...e4.enterFrom, ...e4.leave, ...e4.leaveFrom, ...e4.leaveTo, ...e4.entered), g5(t17, ...e4.base, ...o10, ...r8), u9.nextFrame(() => {
    v3(t17, ...e4.base, ...o10, ...r8), g5(t17, ...e4.base, ...o10, ...l11), b5(t17, () => (v3(t17, ...e4.base, ...o10), g5(t17, ...e4.base, ...e4.entered), p6()));
  }), u9.dispose;
}

// node_modules/@headlessui/react/dist/hooks/use-transition.js
function E7({ immediate: t17, container: s14, direction: n6, classes: u9, onStart: a12, onStop: c12 }) {
  let l11 = f5(), d11 = p(), e4 = s2(n6);
  l(() => {
    ...
    if (i6 && e4.current !== "idle" && l11.current)
      return r8.dispose(), a12.current(e4.current), r8.add(M5(i6, u9.current, e4.current === "enter", () => {
        r8.dispose(), c12.current(e4.current);
      })), r8.dispose;
  }, [n6]);
}
...
function oe2(t17, n6) {
  let r8 = s2(t17), s14 = (0, import_react33.useRef)([]), y6 = f5(), D5 = p(), c12 = o4((i6, e4 = j.Hidden) => {
  ...
  return (0, import_react33.useMemo)(() => ({ children: s14, register: x5, unregister: c12, onStart: v4, onStop: d11, wait: h9, chains: u9 }), [x5, c12, s14, v4, d11, u9, h9]);
}
function xe2() {
}
...
function De3(t17, n6) {
  var K3, Q3;
  let { beforeEnter: r8, afterEnter: s14, beforeLeave: y6, afterLeave: D5, enter: c12, enterFrom: x5, enterTo: p6, entered: h9, leave: u9, leaveFrom: v4, leaveTo: d11, ...i6 } = t17, e4 = (0, import_react33.useRef)(null), a12 = y2(e4, n6), o10 = (K3 = i6.unmount) == null || K3 ? j.Unmount : j.Hidden, { show: f10, appear: P4, initial: T7 } = Se2(), [l11, j5] = (0, import_react33.useState)(f10 ? "visible" : "hidden"), q3 = Ne2(), { register: O3, unregister: V2 } = q3;
  ...
  let k2 = s2({ base: S8(i6.className), enter: S8(c12), enterFrom: S8(x5), enterTo: S8(p6), entered: S8(h9), leave: S8(u9), leaveFrom: S8(v4), leaveTo: S8(d11) }), w6 = Re2({ beforeEnter: r8, afterEnter: s14, beforeLeave: y6, afterLeave: D5 }), G2 = l2();
  (0, import_react33.useEffect)(() => {
    if (G2 && l11 === "visible" && e4.current === null)
      throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e4, l11, G2]);
  let ue2 = T7 && !P4, z4 = P4 && f10 && T7, Te2 = (() => !G2 || ue2 ? "idle" : f10 ? "enter" : "leave")(), H5 = c11(0), de2 = o4((g6) => u(g6, { enter: () => {
  ...
  return z4 ? R3 = { ...R3, className: t6(i6.className, ...k2.current.enter, ...k2.current.enterFrom) } : (R3.className = t6(i6.className, (Q3 = e4.current) == null ? void 0 : Q3.className), R3.className === "" && delete R3.className), import_react33.default.createElement(M6.Provider, { value: A }, import_react33.default.createElement(c5, { value: u(l11, { ["visible"]: d5.Open, ["hidden"]: d5.Closed }) | H5.flags }, X({ ourProps: me3, theirProps: R3, defaultTag: ye3, features: ae2, visible: l11 === "visible", name: "Transition.Child" })));
}
function He2(t17, n6) {
  let { show: r8, appear: s14 = false, unmount: y6 = true, ...D5 } = t17, c12 = (0, import_react33.useRef)(null), x5 = y2(c12, n6);
  l2();
  let p6 = C();
...
function Collection() {
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(tt.Root, { show: mobileFiltersOpen, as: import_react36.Fragment, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(_t, { as: "div", className: "relative z-40 lg:hidden", onClose: setMobileFiltersOpen, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "fixed inset-0 z-40 flex", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
          tt.Child,
          {
            as: import_react36.Fragment,
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(_t.Panel, { className: "relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("form", { className: "mt-4 border-t border-gray-200", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { role: "list", className: "px-2 py-3 font-medium text-gray-900", children: subCategories.map((category) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("a", { href: category.href, className: "block px-2 py-3", children: category.name }, void 0, false, {
                  fileName: "app/routes/($locale).collections.$handle.jsx",
                  lineNumber: 265,
                  columnNumber: 27
                ...
                filters.map((section) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ve, { as: "div", className: "border-t border-gray-200 px-4 py-6", children: ({ open }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
                  console.log(filters),
                  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h3", { className: "-mx-2 -my-3 flow-root", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ve.Button, { className: "flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500", children: [
                    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-medium text-gray-900", children: section.name }, void 0, false, {
                      fileName: "app/routes/($locale).collections.$handle.jsx",
                      lineNumber: 279,
                      columnNumber: 33
                    }, this),
                    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "ml-6 flex items-center", children: open ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(MinusIcon_default, { className: "h-5 w-5", "aria-hidden": "true" }, void 0, false, {
                      fileName: "app/routes/($locale).collections.$handle.jsx",
                      lineNumber: 282,
                      columnNumber: 37
                    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(PlusIcon_default, { className: "h-5 w-5", "aria-hidden": "true" }, void 0, false, {
                      fileName: "app/routes/($locale).collections.$handle.jsx",
                      lineNumber: 284,
                      columnNumber: 37
                    }, this) }, void 0, false, {
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ve.Panel, { className: "pt-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "space-y-6", children: section.options.map((option, optionIdx) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center", children: [
                    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                      "input",
                      {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-4xl font-bold tracking-tight text-gray-900", children: collection.title }, void 0, false, {
            fileName: "app/routes/($locale).collections.$handle.jsx",
            lineNumber: 324,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(it, { as: "div", className: "relative inline-block text-left", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                tt,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(it.Items, { className: "absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "py-1", children: sortOptions.map((option) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(it.Item, { children: ({ active }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                    "a",
                    {
                      href: option.href,
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { type: "button", className: "-m-2 ml-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { "aria-labelledby": "products-heading", className: "pb-24 pt-6", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("form", { className: "hidden lg:block", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h3", { className: "sr-only", children: "Categories" }, void 0, false, {
                fileName: "app/routes/($locale).collections.$handle.jsx",
                lineNumber: 393,
                columnNumber: 17
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { role: "list", className: "space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900", children: subCategories.map((category) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("a", { href: category.href, children: category.name }, void 0, false, {
                fileName: "app/routes/($locale).collections.$handle.jsx",
                lineNumber: 397,
                columnNumber: 23
              }, this) }, category.name, false, {
              ...
              filters.map((section) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ve, { as: "div", className: "border-b border-gray-200 py-6", children: ({ open }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h3", { className: "-my-3 flow-root", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ve.Button, { className: "flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500", children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-medium text-gray-900", children: section.name }, void 0, false, {
                    fileName: "app/routes/($locale).collections.$handle.jsx",
                    lineNumber: 408,
                    columnNumber: 29
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ve.Panel, { className: "pt-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "space-y-4", children: section.options.map((option, optionIdx) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center", children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                    "input",
                    {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "lg:col-span-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full max-w-screen-xl mx-auto lg:px-24 sm:px-4 md:px-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4", children: productsToShow.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white rounded-lg shadow-lg p-2", style: { boxShadow: "0px 4px 8px rgba(255, 217, 90, 0.5)" }, children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                "img",
                {
                  src: product.images.edges[0].node.url,
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "px-1 py-1 flex justify-between items-center", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(F, { route: "/cart", inputs: { lines: lines[index] }, action: F.ACTIONS.LinesAdd, className: "flex-grow", children: (fetcher) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                  "button",
                  {
                    className: "lg:w-[140px] h-11 bg-black hover:bg-blue-700 text-white font-bold py-1 px-1 rounded-lg",
                    type: "submit",
                    onClick: () => {
                      window.location.href = window.location.href + "#cart-aside";
                    },
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-NK5WGVSU.js.map
