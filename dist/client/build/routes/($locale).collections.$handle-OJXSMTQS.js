...
function Collection() {
  ...
  const res = collections.edges.filter((item) => collectionArray.filter((coll) => coll.title.toLowerCase() == item.node.handle));
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-OJXSMTQS.js.map
