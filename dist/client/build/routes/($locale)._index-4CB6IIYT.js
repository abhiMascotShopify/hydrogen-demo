...
} from '/build/_shared/chunk-F44T645T.js';
...
var CustomizedProducts = ({products}) => {
  ...
  const isTablet = (0, import_react_responsive.useMediaQuery)({
    minWidth: 641,
    maxWidth: 1024,
  });
  ...
  const prevProducts = () => {
    setStartIndex((prevIndex) =>
      prevIndex === 0 ? products.length - (products.length % 3) : prevIndex - 3,
    );
  };
  ...
  const products = [
    {
      ...
      name: 'Product 1',
      image:
        'https://th.bing.com/th/id/OIP.JK2oK4OM7F9s9napPoZt0wHaEs?pid=ImgDet&rs=1',
    },
    {
      id: 2,
      name: 'Product 2',
        ...
        'div',
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
              'h1',
              {className: 'text-center', children: 'Gifting Offers'},
              void 0,
              false,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
              ...
              {
                className:
                  'absolute left-0 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 rounded-full p-2 ml-4 hover:bg-opacity-75',
                onClick: () =>
                  setStartIndex((prevIndex) =>
                    prevIndex === 0
                      ? products.length - (products.length % 3)
          ...
          'div',
          {
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
                ...
                {
                  fallback: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
                    'div',
                    {children: 'Loading...'},
                    void 0,
                    false,
...
//# sourceMappingURL=/build/routes/($locale)._index-4CB6IIYT.js.map
