...
// node_modules/@shopify/hydrogen/node_modules/@shopify/hydrogen-react/dist/browser-prod/ExternalVideo.mjs
...
// node_modules/@shopify/hydrogen/node_modules/@shopify/hydrogen-react/dist/browser-prod/MediaFile.mjs
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);

// node_modules/@shopify/hydrogen/node_modules/@shopify/hydrogen-react/dist/browser-prod/Video.mjs
...
// node_modules/@shopify/hydrogen/node_modules/@shopify/hydrogen-react/dist/browser-prod/ModelViewer.mjs
...
// node_modules/@shopify/hydrogen/node_modules/@shopify/hydrogen-react/dist/browser-prod/parse-metafield.mjs
...
var N = "2023.10.3";
var Jt = (0, import_react6.lazy)(() => import("/build/_shared/log-seo-tags-TY72EQWZ-G6FBB7A6.js"));
function rr({ connection: e, children: t = () => (console.warn("<Pagination> requires children to work properly"), null) }) {
  let n = useNavigation().state === "loading", { endCursor: a, hasNextPage: s, hasPreviousPage: o, nextPageUrl: i, nodes: u, previousPageUrl: p, startCursor: d } = nr(e), c = (0, import_react6.useMemo)(() => ({ pageInfo: { endCursor: a, hasPreviousPage: o, hasNextPage: s, startCursor: d }, nodes: u }), [a, s, o, d, u]), f = (0, import_react6.useMemo)(() => (0, import_react6.forwardRef)(function(g, y) {
    return s ? (0, import_react6.createElement)(Link, { preventScrollReset: true, ...g, to: i, state: c, replace: true, ref: y }) : null;
  }), [s, i, c]), l = (0, import_react6.useMemo)(() => (0, import_react6.forwardRef)(function(g, y) {
    return o ? (0, import_react6.createElement)(Link, { preventScrollReset: true, ...g, to: p, state: c, replace: true, ref: y }) : null;
  }), [o, p, c]);
...
function nr(e) {
  ...
  let t = useNavigate(), { state: r, search: n, pathname: a } = useLocation(), i = new URLSearchParams(n).get("direction") === "previous", u = (0, import_react6.useMemo)(() => !globalThis?.window?.__hydrogenHydrated || !r || !r?.nodes ? flattenConnection(e) : i ? [...flattenConnection(e), ...r.nodes] : [...r.nodes, ...flattenConnection(e)], [r, e]), p = (0, import_react6.useMemo)(() => {
  ...
  }, [i, r, e.pageInfo.hasNextPage, e.pageInfo.hasPreviousPage, e.pageInfo.startCursor, e.pageInfo.endCursor]), d = (0, import_react6.useRef)({ params: Y(n), pathname: a });
...
function ee({ children: e, action: t, inputs: r, route: n }) {
  let a = useFetcher();
  return (0, import_jsx_runtime8.jsxs)(a.Form, { action: n || "", method: "post", children: [(t || r) && (0, import_jsx_runtime8.jsx)("input", { type: "hidden", name: yt, value: JSON.stringify({ action: t, inputs: r }) }), typeof e == "function" ? e(a) : e] });
}
ee.INPUT_NAME = yt;
...
function $r({ handle: e, options: t = [], variants: r = [], productPath: n = "products", children: a }) {
  ...
  return (0, import_react6.createElement)(import_react6.Fragment, null, ...(0, import_react6.useMemo)(() => t.filter((d) => d?.values?.length > 1).map((d) => {
    let c, f = [];
...
var ht = (0, import_react6.createContext)(void 0);
var Wr = ht.Provider;
var qe = () => (0, import_react6.useContext)(ht);
var Yr = (0, import_react6.forwardRef)((e, t) => {
  let r = qe();
  return (0, import_jsx_runtime8.jsx)("script", { suppressHydrationWarning: true, ...e, nonce: r, ref: t });
});
...
*/
//# sourceMappingURL=/build/_shared/chunk-SMAMLHOS.js.map
