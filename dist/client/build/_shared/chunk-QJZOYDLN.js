...
var ImageCarousel = ({ images }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "overflow-y-auto h-full md:h-80 border border-gray-300 rounded-lg shadow-lg", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex space-x-4 p-4 group-hover:scrollbar-auto", children: images.map((image, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    "img",
    {
      src: image,
      alt: `Image ${index + 1}`,
...
//# sourceMappingURL=/build/_shared/chunk-QJZOYDLN.js.map
