import "/build/_shared/chunk-54XOZSYV.js";
import "/build/_shared/chunk-4F3247Q3.js";
import {
  PredictiveSearchForm,
  PredictiveSearchResults
} from "/build/_shared/chunk-5ZF6DZMS.js";
import {
  CartMain
} from "/build/_shared/chunk-GPJAKHZW.js";
...
} from "/build/_shared/chunk-6BB7K7SI.js";
import {
  require_react_dom
...
// app/styles/app.css
var app_default = "/build/_assets/app-3KQJCUPW.css";
...
function C() {
  for (var t2, r2, e2 = 0, a = ""; e2 < arguments.length; )
    (t2 = arguments[e2++]) && (r2 = re(t2)) && (a && (a += " "), a += r2);
  return a;
}
var le = ({ theme: t2, style: r2 }) => {
  const [e2, a] = (0, import_react.useState)(false), c = C(
    t2.rippleWave,
    e2 ? t2.rippleWaveActive : t2.rippleWaveInactive
  );
...
var de = (...t2) => {
  ...
  return import_react.default.useEffect(() => {
    t2.forEach((e2) => {
      e2 && (typeof e2 == "function" ? e2(r2.current) : e2.current = r2.current);
    });
  }, [t2]), r2;
};
var De = import_react.default.forwardRef(
  ({
    ...
    const y = (0, import_react.useRef)(null), s = de(v, y), p = { ...ce, ...m }, g = "rgba({{color}}, 0.2) 0, rgba({{color}}, 0.3) 40%, rgba({{color}}, 0.4) 50%, rgba({{color}}, 0.5) 60%, rgba({{color}}, 0) 70%", L = [0, 0, 0], k = [
    ...
    ], [_, z] = (0, import_react.useState)([]), [R, P] = (0, import_react.useState)([]), M = C(p.ripple, t2), I = C(
      ...
      const x = (w = s.current) == null ? void 0 : w.getBoundingClientRect(), N = b.clientX - x.left, $ = b.clientY - x.top, f = x.height, T = x.width, W = {
        ...
        left: e2 ? `${T / 2 - j}px` : `${N - j}px`,
        top: e2 ? `${f / 2 - j}px` : `${$ - j}px`,
...
var Pe = import_react.default.forwardRef(
  ({ className: t2, children: r2, theme: e2, tag: a = "div", ...c }, l) => {
    const i = { ...he, ...e2 }, { scrollable: d } = (0, import_react.useContext)(ee), u = C(
      i.wrapper,
      d && i.scrollable,
      t2
    );
...
var Oe = import_react.default.forwardRef(
  ({ className: t2, children: r2, theme: e2, tag: a = "div", ...c }, l) => {
    const i = { ...ve, ...e2 }, d = C(i.wrapper, t2);
...
var We = import_react.default.forwardRef(
  ({ className: t2, children: r2, theme: e2, tag: a = "div", ...c }, l) => {
    const i = { ...xe, ...e2 }, { scrollable: d } = (0, import_react.useContext)(ee), u = C(
      i.wrapper,
      d && i.scrollable,
      t2
    );
...
var Be = import_react.default.forwardRef(
  ({ className: t2, children: r2, theme: e2, tag: a = "div", ...c }, l) => {
    const i = { ...Te, ...e2 }, d = C(i.wrapper, t2);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(a, { className: d, ...c, ref: l, children: r2 });
  }
);
var ye = {
...
var $e = import_react.default.forwardRef(
  ({
    ...
    var j, Y;
    const [_, z] = (0, import_react.useState)(e2 || a), [R, P] = (0, import_react.useState)(0), [M, I] = (0, import_react.useState)(false), [X, q] = (0, import_react.useState)(false), F = (0, import_react.useRef)(null);
    (0, import_react.useImperativeHandle)(k, () => F.current);
    const o2 = { ...ye, ...y }, K = (0, import_react.useRef)(null), G = n2 || K, b = C(
      o2.input,
      M && o2.activeInput,
    ...
    const W = (w) => {
      ...
      (w) => {
        F.current && (_ !== void 0 && _ != "" || e2 !== void 0 && e2 != "" || F.current.value != "" ? I(true) : I(false), S && S(w));
      },
      [_, e2, S]
    );
...
var Ae = import_react.default.forwardRef(
  ({
    ...
    const n2 = {
      ...
      i ? l ? n2.verticalTabs : n2.pillsTabs : l ? n2.verticalTabs : n2.defaultTabs,
      t2
    );
...
var ze = import_react.default.forwardRef(
  ({
    ...
    const { fill: m, justify: S, vertical: v, pills: y } = (0, import_react.useContext)(ae), s = {
      ...
      y && !a ? e2 ? g[c].pills : s.inactivePillsLink : e2 ? g[c].tabs : s.inactiveTabsLink,
      t2
    );
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { className: p, role: "presentation", ref: n2, ...u, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(d, { className: L, ref: n2, role: "tab", ...u, children: l }) });
  }
);
var Le = {
  tabsContent: "my-2"
...
var Fe = import_react.default.forwardRef(
  ({ className: t2, tag: r2 = "div", children: e2, theme: a, ...c }, l) => {
    const i = {
      ...Le,
      ...a
    }, d = C(i.tabsContent, t2);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(r2, { className: d, ref: l, ...c, children: e2 });
  }
);
var _e = {
...
var je = import_react.default.forwardRef(
  ({
    ...
    return (0, import_react.useEffect)(() => {
      ...
      let k;
      return e2 ? (c == null || c(), k = setTimeout(() => {
        v(true), l == null || l();
    ...
    }, [e2]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(r2, { className: L, role: "tabpanel", ref: s, ...n2, children: u });
  }
);
...
function Header({ header, isLoggedIn, cart }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("header", { className: "header border-b border-gray-200", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(NavLink, { prefetch: "intent", to: "/", style: activeLinkStyle, end: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("img", { className: "w-40", src: "https://cdn.shopify.com/s/files/1/0809/4253/0882/files/Mary_Jo_K_Cult_Makeup_Unit-01.png?v=1709204173" }, void 0, false, {
      ...
      isLargeScreen && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "m-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "relative flex w-full flex-wrap items-stretch", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "rounded w-full", children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("nav", { className, role: "navigation", children: [
    ...
    menu.items.map((item, index) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "relative inline-block text-left group", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("button", { onClick: () => goToCollection(item.url), className: "px-4 py-2 text-gray-800 focus:outline-none", children: item.title }, void 0, false, {
          fileName: "app/components/Header.jsx",
          lineNumber: 147,
          columnNumber: 13
        }, this),
...
function CartBadge({ count }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("a", { href: "#cart-aside", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
      "svg",
      {
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
...
var tailwind_default = "/build/_assets/tailwind-SISAKVSS.css";

// node_modules/@okendo/shopify-hydrogen/dist/esm/index.js
var import_react10 = __toESM(require_react());
var o = ({ nonce: e2 = "", okendoProviderData: n2, productUrlFormatter: r2 }) => {
  if (!n2)
    return null;
  const { reviewsHeaderConfig: o2, cssVariables: i, customCss: s, initScriptContents: a, preRenderStyleTags: d, starSymbols: c } = n2, l = "function" == typeof r2 ? r2.toString() : "string" == typeof r2 ? r2 : `(product) =>
					product && product.productHandle
						? "/products/" + product.productHandle + "/" + (product.variantId ? '?variantId=' + product.variantId : '')
						: undefined`, p = (i ?? "").replace('<style id="oke-css-vars">', "").replace("</style>", ""), u = s ? s.replace('<style id="oke-reviews-custom-css">', "").replace("</style>", "") : "";
  return import_react10.default.createElement(import_react10.default.Fragment, null, import_react10.default.createElement("script", { nonce: e2, id: "oke-reviews-settings", type: "application/json", dangerouslySetInnerHTML: { __html: JSON.stringify(o2) } }), import_react10.default.createElement("style", { nonce: e2, id: "oke-css-vars", dangerouslySetInnerHTML: { __html: p } }), u && import_react10.default.createElement("style", { nonce: e2, id: "oke-reviews-custom-css", dangerouslySetInnerHTML: { __html: u } }), a && import_react10.default.createElement("script", { nonce: e2, dangerouslySetInnerHTML: { __html: a } }), import_react10.default.createElement("script", { nonce: e2, type: "text/javascript", dangerouslySetInnerHTML: { __html: `window.okeProductUrlFormatter = ${l.toString()}` } }), d && import_react10.default.createElement("div", { dangerouslySetInnerHTML: { __html: d } }), c && import_react10.default.createElement("div", { dangerouslySetInnerHTML: { __html: c } }));
};
...
tw-elements-react/dist/js/tw-elements-react.es.min.js:
  ...
  *)
*/
//# sourceMappingURL=/build/root-XDB7JOR4.js.map
